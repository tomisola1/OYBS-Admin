...
import { DonationIcon, RoundArrow, UserIcon } from '../../../public/icons'
            ...
            <div className='flex gap-5'>
                <div className='w-8/12 '>
                    <div className='flex justify-between'>
                        ...
                        <StatCard Icon={<UserIcon/>} Title='Total Users' total='30,678' detail='Active Users: 25,678' className='bg-[#3EC295]'/>
                ...
                <div className='w-2/6 bg-background'>
                    <div className='bg-background'>
                        <h3>Top Donations</h3>
                        <div>

                        </div>
                        <BtnPrimary>View All Donations</BtnPrimary>
                    </div>
                    <div></div>
                </div>
            </div>
